...
# for i in {60..69}
# do
# . / exec_manage init_task --video_path "in/edeka_entrance/dataset_0000$i/edeka_entrance_0000$i.mp4" --task_name "edeka_entrance_0000$i" --labels cart
# done
...
# ./exec_manage init_task --video_path "in/globus_se/dataset_000549/globus_se_000549_test.mp4" --labels cart person

- [User's guide](#users-guide)
  ...
  - [Annotation with cuboids](#annotation-with-cuboids)
    - [Creating the cuboid](#creating-the-cuboid)
    - [Editing the cuboid](#editing-the-cuboid)
  - [Annotation with points](#annotation-with-points-1)
    - [Points in annotation mode](#points-in-annotation-mode)
    - [Linear interpolation with one point](#linear-interpolation-with-one-point-1)
